module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c1 = function(cD, st) { /*vD:variableDeclaration? fD:functionDeclaration* */ 
        ...
        peg$c2 = function(id, val, rest) { 
          
          let declaration = rest.map( ([_, id, __, val]) => [id.value, val.value] ); /* Ignoramos la coma y el igual, ya que no nos interesa */
          
          return [[id.value, val.value]].concat(declaration) /* El valor semántico será un array de parejas con los id y los valores de las constantes */
        },
        ...
        peg$c6 = function(lft, op, rgth) { return { type: op,
        																							left: lft,
        																							right: rght
        																						}},
